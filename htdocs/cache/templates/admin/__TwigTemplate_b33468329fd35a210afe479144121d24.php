...
/* layout.manage.tpl */
class __TwigTemplate_b33468329fd35a210afe479144121d24 extends Twig_Template
{
...
\t// do the ajax request
\tdocument.getElementById('TemplateVersionCheck').innerHTML = '<em>";
        // line 71
        echo getLang("MountingTemplates");
        echo "...</em>';
...
\t\t\t\t\t<input type=\"button\" value=\"";
        ...
        echo "\" class=\"SmallButton\" class=\"Button\" onclick=\"LaunchEditor();\">
\t\t\t\t\t<input type=\"Button\" class=\"SmallButton\" onclick=\"CheckTemplateVersion();\" value=\"";
        // line 296
        echo getLang("CheckNewVersion");
        echo "\"  id=\"TemplateVersionCheckButton\">
\t\t\t\t\t<input type=\"Button\" class=\"SmallButton\" onclick=\"DownloadNewVersion();\" value=\"";
        // line 297
        echo getLang("DownloadNewVersion");
        echo "\"  id=\"DownloadNewVersionButton\" style=\"display:none; font-weight: bold;\">
\t\t\t\t\t<input type=\"button\" value=\"";
        // line 298
        echo getLang("MountTemplates");
        echo "\" class=\"SmallButton\" class=\"Button\" onclick=\"MountTemplates();\"><br /><br />
