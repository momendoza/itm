...
/* page.form.tpl */
class __TwigTemplate_22294d4e8e6ae864c15d20b449158b36 extends Twig_Template
{
...
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield7\" name=\"contactfields[rma]\" value=\"rma\" ";
        ...
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield8\" name=\"contactfields[names]\" value=\"names\" ";
        // line 134
        echo twig_safe_filter((isset($context['IsContactNames']) ? $context['IsContactNames'] : null));
        echo "><label for=\"contactfield8\">";
        echo getLang("ContactNames");
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield9\" name=\"contactfields[lastname]\" value=\"lastname\" ";
        // line 135
        echo twig_safe_filter((isset($context['IsContactLastName']) ? $context['IsContactLastName'] : null));
        echo "><label for=\"contactfield9\">";
        echo getLang("ContactLastName");
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield10\" name=\"contactfields[address]\" value=\"address\" ";
        // line 136
        echo twig_safe_filter((isset($context['IsContactAddress']) ? $context['IsContactAddress'] : null));
        echo "><label for=\"contactfield10\">";
        echo getLang("ContactAddress");
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield11\" name=\"contactfields[colony]\" value=\"colony\" ";
        // line 137
        echo twig_safe_filter((isset($context['IsContactColony']) ? $context['IsContactColony'] : null));
        echo "><label for=\"contactfield11\">";
        echo getLang("ContactColony");
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield12\" name=\"contactfields[country]\" value=\"country\" ";
        // line 138
        echo twig_safe_filter((isset($context['IsContactCountry']) ? $context['IsContactCountry'] : null));
        echo "><label for=\"contactfield12\">";
        echo getLang("ContactCountry");
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield13\" name=\"contactfields[city]\" value=\"city\" ";
        // line 139
        echo twig_safe_filter((isset($context['IsContactCity']) ? $context['IsContactCity'] : null));
        echo "><label for=\"contactfield13\">";
        echo getLang("ContactCity");
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield14\" name=\"contactfields[zip]\" value=\"zip\" ";
        // line 140
        echo twig_safe_filter((isset($context['IsContactZip']) ? $context['IsContactZip'] : null));
        echo "><label for=\"contactfield14\">";
        echo getLang("ContactZip");
        echo "</label><br />
\t\t\t\t\t\t<input type=\"checkbox\" id=\"contactfield15\" name=\"contactfields[birthday]\" value=\"birthday\" ";
        // line 141
        echo twig_safe_filter((isset($context['IsContactBirthday']) ? $context['IsContactBirthday'] : null));
        echo "><label for=\"contactfield15\">";
        echo getLang("ContactBirthday");
        echo "</label>
...
\t\t\t\t\t\t\t<option value=\"0\" ";
        // line 256
        echo twig_escape_filter($this->env, (isset($context['PageCustomerOnlySelected0']) ? $context['PageCustomerOnlySelected0'] : null), "1");
        echo ">No</option>
\t\t\t\t\t\t\t<option value=\"1\" ";
        // line 257
        echo twig_escape_filter($this->env, (isset($context['PageCustomerOnlySelected1']) ? $context['PageCustomerOnlySelected1'] : null), "1");
        echo ">Si, todos los usuarios registrados</option>
\t\t\t\t\t\t\t<option value=\"2\" ";
        // line 258
        echo twig_escape_filter($this->env, (isset($context['PageCustomerOnlySelected2']) ? $context['PageCustomerOnlySelected2'] : null), "1");
        echo ">Si, elegir por grupos de usuarios</option>
\t\t\t\t\t\t</select>
